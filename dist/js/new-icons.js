;(function () {
  ...
  function tabSelected() {
    const tabSelected = document.getElementsByClassName('selected')[0].getAttributeNode('data-name').value
    return tabSelected
  }
  ...
  document.getElementById('tab').onclick = function (e) {
    ...
    const targetName = e.target.getAttribute('data-name') || e.target.parentNode.getAttribute('data-name');
